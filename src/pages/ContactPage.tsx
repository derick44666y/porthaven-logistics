      ...
      <div className="max-w-2xl mx-auto text-center">
        ...
        <div className="space-y-4">
          ...
          <a
            ...
            className="flex items-center justify-center gap-4 bg-green-600 hover:bg-green-500 text-white py-5 rounded-2xl font-semibold text-lg shadow-lg transition-colors"
          >
